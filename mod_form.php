...
/**
 * The main notification configuration form
 *
 ...
 */
class mod_notification_mod_form extends moodleform_mod {
    ...
    public function definition() {
        ...
        $mform->addElement('text', 'name', get_string('notificationname', 'notification'), array('size' => '64'));
        ...
        $mform->addHelpButton('name', 'notificationname', 'notification');
